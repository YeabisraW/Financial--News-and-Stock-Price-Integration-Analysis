...
output_csv = "results/technical_analysis_MSFT.csv"
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_close_sma_MSFT.png")
plt.close()
...
plt.ylabel("RSI")
plt.tight_layout()
plt.savefig("results/plot_rsi_MSFT.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_macd_MSFT.png")
plt.close()
