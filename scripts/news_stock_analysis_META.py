...
stock = pd.read_csv("META.csv", parse_dates=['Date'])
...
merged_csv = "results/sentiment_stock_correlation_META.csv"
...
plt.tight_layout()
plt.savefig("results/sentiment_vs_stock_return_META.png")
plt.close()
print("Scatter plot saved: results/sentiment_vs_stock_return_META.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/sentiment_and_returns_timeseries_META.png")
plt.close()
print("Time series plot saved: results/sentiment_and_returns_timeseries_META.png")
