...
stock = pd.read_csv("MSFT.csv", parse_dates=['Date'])
...
merged_csv = "results/sentiment_stock_correlation_MSFT.csv"
...
plt.tight_layout()
plt.savefig("results/sentiment_vs_stock_return_MSFT.png")
plt.close()
print("Scatter plot saved: results/sentiment_vs_stock_return_MSFT.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/sentiment_and_returns_timeseries_MSFT.png")
plt.close()
print("Time series plot saved: results/sentiment_and_returns_timeseries_MSFT.png")
