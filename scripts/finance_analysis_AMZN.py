...
output_csv = "results/technical_analysis_AMZN.csv"
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_close_sma_AMZN.png")
plt.close()
...
plt.ylabel("RSI")
plt.tight_layout()
plt.savefig("results/plot_rsi_AMZN.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_macd_AMZN.png")
plt.close()
