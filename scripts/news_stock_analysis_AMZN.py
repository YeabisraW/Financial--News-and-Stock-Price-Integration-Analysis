...
merged_csv = "results/sentiment_stock_correlation_AMZN.csv"
...
plt.tight_layout()
plt.savefig("results/sentiment_vs_stock_return_AMZN.png")
plt.close()
print("Scatter plot saved: results/sentiment_vs_stock_return_AMZN.png")
...
plt.legend()
plt.tight_layout()
plt.savefig("results/sentiment_and_returns_timeseries_AMZN.png")
plt.close()
print("Time series plot saved: results/sentiment_and_returns_timeseries_AMZN.png")
