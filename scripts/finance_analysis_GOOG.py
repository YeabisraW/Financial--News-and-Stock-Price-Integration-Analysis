...
output_csv = "results/technical_analysis_GOOG.csv"
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_close_sma_GOOG.png")
plt.close()
...
plt.ylabel("RSI")
plt.tight_layout()
plt.savefig("results/plot_rsi_GOOG.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_macd_GOOG.png")
plt.close()
