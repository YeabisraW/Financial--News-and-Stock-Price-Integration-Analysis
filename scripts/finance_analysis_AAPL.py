...
output_csv = "results/technical_analysis_AAPL.csv"
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_close_sma_AAPL.png")
plt.close()
...
plt.ylabel("RSI")
plt.tight_layout()
plt.savefig("results/plot_rsi_AAPL.png")
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig("results/plot_macd_AAPL.png")
plt.close()
